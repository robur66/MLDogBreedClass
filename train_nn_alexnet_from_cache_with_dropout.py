...
h1 = dense_batch_relu(dropout1, 256, phase,'layer1')
dropout2 = tf.nn.dropout(h1, 0.5)
h2 = dense_batch_relu(dropout2, 120, phase, 'layer2')
# dropout3 = tf.nn.dropout(h2, 0.8)
...
dropout1 = tf.nn.dropout(X_t, 0.5)
h1 = dense_batch_relu(dropout1, 100, phase,'layer1')
dropout2 = tf.nn.dropout(h1, 0.5)
h2 = dense_batch_relu(dropout2, 60, phase, 'layer2')
# dropout3 = tf.nn.dropout(h2, 0.8)
logits = dense(h2, n_y, 'logits')
